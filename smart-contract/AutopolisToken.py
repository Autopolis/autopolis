...
"""
token of Autopollism based on hashgard HRC-10
"""
...
StandardTokenContractAdress = 'contractb50c6927b66948aedfa80f6f7256c8159acc82f2'
...
def StandardTokenContract(params):
    return Register(StandardTokenContractAdress, params)
